\doxysection{Time\+At\+Fraction.\+h}
\hypertarget{_time_at_fraction_8h_source}{}\label{_time_at_fraction_8h_source}\index{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/TimeAtFraction.h@{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/TimeAtFraction.h}}
...
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{comment}{//Ben\ Newton,\ July\ 15,\ 2015}}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{comment}{/*}}
\DoxyCodeLine{00034\ \textcolor{comment}{*\ TimeAtFraction\ -\/\ Signature\ for\ the\ "{}sample\ time\ at\ specific}}
\DoxyCodeLine{00035\ \textcolor{comment}{*\ distance\ fraction"{}\ algorithm.\ \ Must\ be\ specialized\ by\ subclasses.}}
\DoxyCodeLine{00036\ \textcolor{comment}{*/}}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{preprocessor}{\#ifndef\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_TimeAtFraction\_h}}
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#define\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_TimeAtFraction\_h}}
\DoxyCodeLine{00040\ }
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#include\ <boost/mpl/assert.hpp>}}
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#include\ <tracktable/Core/Timestamp.h>}}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00047\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtracktable_1_1algorithms_1_1time__at__fraction}{time\_at\_fraction}}}
\DoxyCodeLine{00048\ \{}
\DoxyCodeLine{00049\ \ \ BOOST\_MPL\_ASSERT\_MSG(}
\DoxyCodeLine{00050\ \ \ \ \ \textcolor{keyword}{sizeof}(T)==0,}
\DoxyCodeLine{00051\ \ \ \ \ TIME\_AT\_FRACTION\_NOT\_IMPLEMENTED\_FOR\_THIS\_TRAJECTORY\_TYPE,}
\DoxyCodeLine{00052\ \ \ \ \ (types<T>)}
\DoxyCodeLine{00053\ \ \ \ \ );}
\DoxyCodeLine{00054\ \};}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \}\ \}\ \textcolor{comment}{//\ exit\ namespace\ tracktable::algorithms}}
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \textcolor{comment}{//\ Now\ we\ include\ the\ driver\ functions\ that\ let\ us\ use\ the}}
\DoxyCodeLine{00059\ \textcolor{comment}{//\ implementations\ in\ functions\ instead\ of\ instantiating\ them\ manually.}}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetracktable}{tracktable}}\ \{}
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ TrajectoryT>}
\DoxyCodeLine{00064\ \mbox{\hyperlink{namespacetracktable_a682e5fb98918f65770834e07ff51d21c}{Timestamp}}\ time\_at\_fraction(TrajectoryT\ \textcolor{keyword}{const}\&\ path,\ \textcolor{keywordtype}{double}\ fraction)}
\DoxyCodeLine{00065\ \{}
\DoxyCodeLine{00066\ \ \ \textcolor{keywordflow}{return}\ algorithms::time\_at\_fraction<TrajectoryT>::apply(path,\ fraction);}
\DoxyCodeLine{00067\ \}}
\DoxyCodeLine{00068\ }
\DoxyCodeLine{00069\ \}\ \textcolor{comment}{//\ exit\ namespace\ tracktable}}
\DoxyCodeLine{00070\ }
