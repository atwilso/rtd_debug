\doxysection{Undecorated\+Point.\+h}
\hypertarget{_undecorated_point_8h_source}{}\label{_undecorated_point_8h_source}\index{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/trait\_signatures/UndecoratedPoint.h@{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/trait\_signatures/UndecoratedPoint.h}}
...
\DoxyCodeLine{00032\ \textcolor{comment}{\ *\ Undecorated\ point\ -\/-\/\ "{}Give\ me\ a\ point\ type\ with\ the\ same\ dimension}}
\DoxyCodeLine{00033\ \textcolor{comment}{\ *\ and\ coordinate\ system\ but\ without\ any\ TrajectoryPoint\ stuff."{}}}
\DoxyCodeLine{00034\ \textcolor{comment}{\ */}}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#ifndef\ \_\_tracktable\_core\_detail\_traits\_undecorated\_point\_h}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#define\ \_\_tracktable\_core\_detail\_traits\_undecorated\_point\_h}}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#include\ <boost/mpl/assert.hpp>}}
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#include\ <boost/mpl/size\_t.hpp>}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#include\ <boost/mpl/bool.hpp>}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetracktable}{tracktable}}\ \{\ \textcolor{keyword}{namespace\ }traits\ \{}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00046\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtracktable_1_1traits_1_1undecorated__point}{undecorated\_point}}\ \{}
\DoxyCodeLine{00047\ \ \ \ \ BOOST\_MPL\_ASSERT\_MSG(}
\DoxyCodeLine{00048\ \ \ \ \ \textcolor{keyword}{sizeof}(T)==0,}
\DoxyCodeLine{00049\ \ \ \ \ UNDECORATED\_POINT\_NOT\_DEFINED\_FOR\_THIS\_TYPE,}
\DoxyCodeLine{00050\ \ \ \ \ (types<T>)}
\DoxyCodeLine{00051\ \ \ \ \ );}
\DoxyCodeLine{00052\ \};}
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00054\ \}\ \}\ \textcolor{comment}{//\ exit\ namespace\ tracktable::traits}}
\DoxyCodeLine{00055\ }
