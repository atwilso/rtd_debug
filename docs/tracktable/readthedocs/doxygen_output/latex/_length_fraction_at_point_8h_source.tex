\doxysection{Length\+Fraction\+At\+Point.\+h}
\hypertarget{_length_fraction_at_point_8h_source}{}\label{_length_fraction_at_point_8h_source}\index{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/LengthFractionAtPoint.h@{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/LengthFractionAtPoint.h}}
...
\DoxyCodeLine{00032\ \textcolor{comment}{\ *\ Length\ Fraction\ At\ Point\ -\/\ signature\ for\ the\ "{}length\ fraction"{}\ algorithm.}}
\DoxyCodeLine{00033\ \textcolor{comment}{\ */}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#ifndef\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_LengthFractionAtPoint\_h}}
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#define\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_LengthFractionAtPoint\_h}}
\DoxyCodeLine{00037\ }
...
\DoxyCodeLine{00043\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtracktable_1_1algorithms_1_1current__length__fraction}{current\_length\_fraction}}}
\DoxyCodeLine{00044\ \{}
\DoxyCodeLine{00045\ \ \ \ \ BOOST\_MPL\_ASSERT\_MSG(}
\DoxyCodeLine{00046\ \ \ \ \ \ \ \ \ \textcolor{keyword}{sizeof}(P)\ ==\ 0,}
\DoxyCodeLine{00047\ \ \ \ \ \ \ \ \ CURRENT\_LENGTH\_FRACTION\_NOT\_IMPLEMENTED\_FOR\_THIS\_TRAJECTORY\_POINT\_TYPE,}
\DoxyCodeLine{00048\ \ \ \ \ \ \ \ \ (types<P>)}
\DoxyCodeLine{00049\ \ \ \ \ );}
\DoxyCodeLine{00050\ \};}
\DoxyCodeLine{00051\ }
\DoxyCodeLine{00052\ \}\ \}\ \textcolor{comment}{//\ exit\ namespace\ tracktable::algorithms}}
\DoxyCodeLine{00053\ }
\DoxyCodeLine{00054\ \textcolor{comment}{//\ Now\ we\ include\ the\ driver\ functions\ that\ let\ us\ use\ the}}
\DoxyCodeLine{00055\ \textcolor{comment}{//\ implementations\ in\ functions\ instead\ of\ instantiating\ them\ manuall.}}
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00057\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetracktable}{tracktable}}\ \{}
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ Po\textcolor{keywordtype}{int}P>}
\DoxyCodeLine{00060\ \textcolor{keywordtype}{double}\ current\_length\_fraction(PointP\ \textcolor{keyword}{const}\&\ point)}
\DoxyCodeLine{00061\ \{}
\DoxyCodeLine{00062\ \ \ \ \ \textcolor{keywordflow}{return}\ point.current\_length\_fraction();}
\DoxyCodeLine{00063\ \}}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ \}\ \textcolor{comment}{//\ exit\ namespace\ tracktable}}
\DoxyCodeLine{00066\ }
