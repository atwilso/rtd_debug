\doxysection{End\+To\+End\+Distance.\+h}
\hypertarget{_end_to_end_distance_8h_source}{}\label{_end_to_end_distance_8h_source}\index{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/EndToEndDistance.h@{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/EndToEndDistance.h}}
...
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#ifndef\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_EndToEndDistance\_h}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#define\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_EndToEndDistance\_h}}
\DoxyCodeLine{00038\ }
...
\DoxyCodeLine{00044\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtracktable_1_1algorithms_1_1end__to__end__distance}{end\_to\_end\_distance}}}
\DoxyCodeLine{00045\ \{}
\DoxyCodeLine{00046\ \ \ BOOST\_MPL\_ASSERT\_MSG(}
\DoxyCodeLine{00047\ \ \ \ \ \textcolor{keyword}{sizeof}(T)==0,}
\DoxyCodeLine{00048\ \ \ \ \ END\_TO\_END\_DISTANCE\_NOT\_IMPLEMENTED\_FOR\_THIS\_TRAJECTORY\_TYPE,}
...
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \textcolor{comment}{//\ Now\ we\ include\ the\ driver\ functions\ that\ let\ us\ use\ the}}
\DoxyCodeLine{00056\ \textcolor{comment}{//\ implementations\ in\ functions\ instead\ of\ instantiating\ them\ manuall.}}
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetracktable}{tracktable}}\ \{}
\DoxyCodeLine{00059\ }
\DoxyCodeLine{00060\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ TrajectoryT>}
\DoxyCodeLine{00061\ \textcolor{keywordtype}{double}\ end\_to\_end\_distance(TrajectoryT\ \textcolor{keyword}{const}\&\ path)}
\DoxyCodeLine{00062\ \{}
\DoxyCodeLine{00063\ \ \ \textcolor{keywordflow}{return}\ algorithms::end\_to\_end\_distance<TrajectoryT>::apply(path);}
\DoxyCodeLine{00064\ \}}
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ }
