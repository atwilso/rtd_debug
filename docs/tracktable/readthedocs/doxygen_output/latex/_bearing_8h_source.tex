\doxysection{Bearing.\+h}
\hypertarget{_bearing_8h_source}{}\label{_bearing_8h_source}\index{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/Bearing.h@{/Users/atwilso/projects/rtd\_debug/rtd\_debug/src/tracktable/cpp/Core/detail/algorithm\_signatures/Bearing.h}}
...
\DoxyCodeLine{00032\ \textcolor{comment}{\ *\ Bearing\ -\/-\/\ signature\ for\ the\ "{}bearing\ between\ two\ points"{}\ algorithm.}}
\DoxyCodeLine{00033\ \textcolor{comment}{\ */}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#ifndef\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_Bearing\_h}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#define\ \_\_tracktable\_core\_detail\_algorithm\_signatures\_Bearing\_h}}
\DoxyCodeLine{00038\ }
...
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{comment}{//\ Implement\ this\ for\ a\ point\ type\ in\ order\ to\ compute\ the\ bearing}}
\DoxyCodeLine{00045\ \textcolor{comment}{//\ from\ one\ point\ to\ another.}}
\DoxyCodeLine{00046\ \textcolor{keyword}{template}<\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00047\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structtracktable_1_1algorithms_1_1bearing}{bearing}}}
\DoxyCodeLine{00048\ \{}
\DoxyCodeLine{00049\ \ \ BOOST\_MPL\_ASSERT\_MSG(}
\DoxyCodeLine{00050\ \ \ \ \ \textcolor{keyword}{sizeof}(T)==0,}
\DoxyCodeLine{00051\ \ \ \ \ BEARING\_NOT\_DEFINED\_FOR\_THIS\_TYPE,}
\DoxyCodeLine{00052\ \ \ \ \ (types<T>)}
\DoxyCodeLine{00053\ \ \ \ \ );}
\DoxyCodeLine{00054\ \};}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \}\ \}\ \textcolor{comment}{//\ namespace\ tracktable::algorithms}}
\DoxyCodeLine{00057\ }
\DoxyCodeLine{00058\ \textcolor{comment}{/*}}
\DoxyCodeLine{00059\ \textcolor{comment}{\ *\ Now\ we\ have\ functions\ that\ wrap\ the\ algorithms\ structs\ so\ that\ we\ can}}
\DoxyCodeLine{00060\ \textcolor{comment}{\ *\ call\ them\ easily\ instead\ of\ worrying\ about\ instantiation.}}
\DoxyCodeLine{00061\ \textcolor{comment}{\ */}}
\DoxyCodeLine{00062\ }
\DoxyCodeLine{00063\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetracktable}{tracktable}}\ \{}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00065\ \textcolor{keyword}{template}<\textcolor{keyword}{class}\ T>}
\DoxyCodeLine{00066\ \textcolor{keywordtype}{double}\ bearing(T\ \textcolor{keyword}{const}\&\ from,\ T\ \textcolor{keyword}{const}\&\ to)}
\DoxyCodeLine{00067\ \{}
\DoxyCodeLine{00068\ \ \ \textcolor{keywordflow}{return}\ algorithms::bearing<T>::apply(from,\ to);}
\DoxyCodeLine{00069\ \}}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \}\ \textcolor{comment}{//\ namespace\ tracktable}}
\DoxyCodeLine{00072\ }
